    ...
    <table class="table table-sm" id="table_list">
        ...
        if (is_array($arrIDs) && count($arrIDs) >= 1) {
            foreach ($arrIDs as $run => $arrEntry) {
                ...
                $objTmp = CBinitObject(ucfirst($strModuleName),$arrEntry[$objTmp->strPrimaryKey]);
                ...
                <tr class="classid_entry" style="<?php echo $strStyle; ?>"
                    ...
                    <td>
                        <?php
                        echo $objTmp->getAttribute('content_id');
                        ?>
                    </td>
                    ...
                    <td>
                        <?php
                        echo $objTmp->getAttribute('structure_id');
                        ?>
                    </td>
